...
function getAffectedSystems(notams) {
    ...
    notams.forEach(notam => {
        ...
        if (notam.details.includes('ILS')) systems.add('ILS');
        if (notam.details.includes('VOR')) systems.add('VOR');
        if (notam.details.includes('DME')) systems.add('DME');
        if (notam.details.includes('RWY')) systems.add('RWY');
        if (notam.details.includes('FUEL')) systems.add('FUEL');
        if (notam.details.includes('SEI')) systems.add('SEI');
